-- Reports Realtime System Migration
-- Run this in Supabase SQL Editor

-- 1. Create reports table with realtime support
...
-- 6. Create function to calculate time elapsed
...
-- 7. Create function to get report statistics
...
-- 8. Enable realtime for reports table
