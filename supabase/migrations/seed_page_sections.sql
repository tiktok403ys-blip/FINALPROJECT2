...
-- Reports page
('reports', 'hero', 'Casino Reports & Analysis - December 2024', 'Get comprehensive insights into the online casino industry with our detailed reports and analysis. Our expert team provides in-depth reviews, market trends, and regulatory updates to help you make informed decisions about online gambling in Singapore.', 1, true),
...
-- Casinos page
('casinos', 'hero', 'Best Online Casinos in Singapore - December 2024', 'Discover the top-rated online casinos for Singapore players. Our expert team has tested and reviewed hundreds of casinos to bring you only the most trustworthy, secure, and entertaining platforms with the best games and bonuses.', 1, true),

-- Bonuses page
('bonuses', 'hero', 'Best Casino Bonuses for December 2024 - Exclusive Offers', 'Discover the most generous casino bonuses and exclusive promotional offers available this month. Our team verifies every bonus to ensure you get the best value and fair terms. From welcome bonuses to free spins, find the perfect offer for your gaming style.', 1, true);
