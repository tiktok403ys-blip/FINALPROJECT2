                  ...
                  return (
                    <div key={item.name} className="relative dropdown-container">
                      ...
                      {activeDropdown === item.name && (
                        <div className="absolute top-full left-1/2 -translate-x-1/2 md:left-0 md:translate-x-0 w-64 bg-black/50 backdrop-blur-xl border border-white/20 rounded-b-2xl rounded-t-none shadow-2xl z-50">
                          <div className="p-2">
