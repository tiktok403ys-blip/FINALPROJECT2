    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4 py-24">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-white mb-2">Join Casino Guide</h1>
        ...
        <GlassCard className="p-8">
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <Button type="submit" className="w-full bg-[#00ff88] text-black hover:bg-[#00ff88]/80" disabled={loading}>
          ...
          <div className="mt-6">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full mt-4 border-white/10 text-white hover:bg-white/5 bg-transparent"
